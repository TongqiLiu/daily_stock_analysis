...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "AGENT_LLM_TRANSIENT_RETRIES": {
        "title": "Agent LLM Transport Retries",
        "description": "Extra full-model-chain retry rounds for connection and timeout failures only.",
        "category": "agent",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
        ...
        "display_order": 69,
        "help_key": "settings.agent.AGENT_LLM_TRANSIENT_RETRIES",
        "examples": [
            "AGENT_LLM_TRANSIENT_RETRIES=2",
            "AGENT_LLM_TRANSIENT_RETRIES=4",
        ],
        "docs": [
            {
                "label": "LLM 配置指南：问股 Agent",
                "href": "https://github.com/ZhuLinsen/daily_stock_analysis/blob/main/docs/LLM_CONFIG_GUIDE.md#问股-agent--litellm-配置兼容说明",
            },
        ],
        "warning_codes": [],
    },
    "AGENT_LLM_RETRY_BASE_DELAY_S": {
        "title": "Agent LLM Retry Base Delay",
        "description": "Exponential backoff base in seconds for transport-only Agent LLM retries.",
        "category": "agent",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
        ...
        "display_order": 70,
        "help_key": "settings.agent.AGENT_LLM_RETRY_BASE_DELAY_S",
        "examples": [
            "AGENT_LLM_RETRY_BASE_DELAY_S=2",
            "AGENT_LLM_RETRY_BASE_DELAY_S=5",
        ],
        "docs": [
            {
                "label": "LLM 配置指南：问股 Agent",
    ...
    "AGENT_LLM_UPSTREAM_STREAM": {
        "title": "Agent Upstream Streaming",
        "description": "Consume upstream LLM output incrementally and rebuild the normal Agent response. This reduces idle gateway disconnects during long inference without changing the user-facing Agent response contract.",
        "category": "agent",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
        ...
        "validation": {},
        "display_order": 71,
        "help_key": "settings.agent.AGENT_LLM_UPSTREAM_STREAM",
        "examples": [
            "AGENT_LLM_UPSTREAM_STREAM=false",
    ...
    "AGENT_CONTEXT_SUMMARY_TIMEOUT_S": {
        "title": "Context Summary Timeout",
        "description": "Timeout in seconds for the LLM call that compresses visible Agent chat history.",
        "category": "agent",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
