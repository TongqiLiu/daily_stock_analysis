...
class AgentOrchestrator:
    ...
    def chat(
        ...
        return self.execute_turn(turn, **execute_kwargs)
    ...
    def execute_turn(
        ...
        *,
        ...
        orch_result = self._execute_pipeline(turn.context, **pipeline_kwargs)

        # Persist assistant response
        if self._is_cancel_requested(cancel_event):
            logger.info("Skipping assistant persistence for cancelled session %s", turn.session_id)
