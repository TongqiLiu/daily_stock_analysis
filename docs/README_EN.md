...
| `DEFAULT_MARKET_CONTEXT` | When no stock code is bound, LLM market guidelines use this market (`cn` / `hk` / `us`, default `us`); explicit codes still override detection | Optional |
