...
| [Capabilities Map](capabilities/README.md) <sub><sub>![P2 Badge](https://img.shields.io/badge/P2-yellow?style=flat)</sub></sub> (Chinese-only) | Single-page overview of triggers, skills, agent tools, data sources, notifications, API endpoints, and extension guide |
