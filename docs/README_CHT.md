...
[**產品預覽**](#-產品預覽) · [**功能特性**](#-功能特性) · [**快速開始**](#-快速開始) · [**推送效果**](#-推送效果) · [**文檔中心**](./INDEX.md) · [**完整指南**](./full-guide.md) · [**能力總覽**](./capabilities/README.md)
...
| Agent 策略問股 | 多輪追問，支援五維、Serenity 投研、日內做T、均線、纏論、波浪、趨勢、熱點、事件、成長、預期等 27 種可選策略，覆蓋 Web/Bot/API |
...
- 支援日內做T、均線金叉、纏論、波浪理論、多頭趨勢、熱點題材、事件驅動、成長品質、預期重估等內建策略
