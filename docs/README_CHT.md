...
[**功能特性**](#-功能特性) · [**快速開始**](#-快速開始) · [**推送效果**](#-推送效果) · [**完整指南**](./full-guide.md) · [**能力總覽**](./capabilities/README.md) · [**常見問題**](./FAQ.md) · [**更新日誌**](./CHANGELOG.md)
...
| `DEFAULT_MARKET_CONTEXT` | 無綁定股票代碼時，問股／分析注入的預設市場語境（`cn`／`hk`／`us`，預設 `us`）；訊息或上下文帶代碼時仍按代碼識別市場 | 可選 |
