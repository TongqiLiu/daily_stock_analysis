...
[**产品预览**](#-产品预览) · [**功能特性**](#-功能特性) · [**快速开始**](#-快速开始) · [**推送效果**](#-推送效果) · [**文档中心**](docs/INDEX.md) · [**完整指南**](docs/full-guide.md) · [**能力总览**](docs/capabilities/README.md)
...
| Agent 策略问股 | 多轮追问，支持五维、Serenity 投研、日内做T、均线、缠论、波浪、趋势、热点、事件、成长、预期、VCP 等 27 种可选策略，覆盖 Web/Bot/API |
...
- 支持日内做T、均线金叉、缠论、波浪理论、多头趋势、热点题材、事件驱动、成长质量、预期重估等内置策略
