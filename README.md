...
[**功能特性**](#-功能特性) · [**快速开始**](#-快速开始) · [**推送效果**](#-推送效果) · [**完整指南**](docs/full-guide.md) · [**能力总览**](docs/capabilities/README.md) · [**常见问题**](docs/FAQ.md) · [**更新日志**](docs/CHANGELOG.md)
...
| `DEFAULT_MARKET_CONTEXT` | 无股票代码时问股/分析注入的默认市场语境（`cn` / `hk` / `us`，默认 `us`）；消息或上下文中带代码时仍按代码识别市场 | 可选 |
